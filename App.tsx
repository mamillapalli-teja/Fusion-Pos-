...
import { ViewType, Order, MenuItem, OrderStatus, DispatchType, OrderItem } from './types';

// Mock Data
const MOCK_MENU: MenuItem[] = [
    { id: '1', name: 'Margherita Pizza', price: 12.99, category: 'Pizza', imageUrl: 'https://picsum.photos/id/102/400/300' },
    { id: '2', name: 'Pepperoni Pizza', price: 14.99, category: 'Pizza', imageUrl: 'https://picsum.photos/id/103/400/300' },
    { id: '3', name: 'Cheeseburger', price: 9.99, category: 'Burgers', imageUrl: 'https://picsum.photos/id/104/400/300' },
    ...
    { id: '8', name: 'Veggie Burger', price: 10.99, category: 'Burgers', imageUrl: 'https://picsum.photos/id/113/400/300' },
...
const MOCK_INITIAL_ORDERS: Order[] = [
    { id: 'ord1', orderNumber: 101, items: [{...MOCK_MENU[2], quantity: 1}, {...MOCK_MENU[5], quantity: 2}], dispatchType: DispatchType.DINE_IN, status: OrderStatus.NEW, createdAt: new Date(Date.now() - 120000), tableNumber: 5, subtotal: 33.99, tax: 2.72, total: 36.71 },
